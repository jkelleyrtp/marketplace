...
filename = (
    "helium10-black-box-www.amazon.it-"
    + str(today.year)
    + "-"
    + str(today.month)
    + "-"
...
class Helium:
    ...
    def Set_Revenue_Min(self, revenue_min):
        ...
        textbox_revenue_min = self.driver.find_element_by_id(
            "filter-monthlyRevenue-min"
        )
    ...
    def Set_Fulfillment(self, fulfillment):
        ...
        self.driver.find_element_by_xpath(
            '//label[@title="'
            + fulfillment
            + '"]//input[@type="checkbox"][@name="filter-seller-type"]'
        ).click()
        # DESELEZIONA LA SIZE
        self.driver.find_element_by_xpath('//*[@title="Small Standard-Size"]').click()
        self.driver.find_element_by_xpath(
            '//label[@title="Small Standard-Size"]//input[@type="checkbox"][@name="filter-size-tiers"]'
        ).click()
...
s1 = Helium(
    "Inserisci username dell'account HELIUM10",
    "Inserisci password dell'account HELIUM10",
